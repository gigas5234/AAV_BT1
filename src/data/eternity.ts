...
export function eternityContent(lang: Lang): EternityContent {
  ...
  if (lang === 'es')
    return {
      title: 'Ruta de habilidades recomendada',
      intro: 'En Eternity’s Reach cada nivel te hace elegir la habilidad de la izquierda o la de la derecha. La ruta más comprobada es la de abajo.',
      levelUp: 'Los niveles de habilidad solo se consiguen cazando a Cesare. Al principio, prioriza matar a Cesare rápido y a menudo antes que trabajar las vetas.',
      pathTitle: 'Ruta recomendada',
      pathNote: 'Primero adelanta los ingresos de cobre y la velocidad de rotación, y después pasa a la captura de vetas y la eficiencia de recolección.',
      sideL: 'Izquierda',
      sideR: 'Derecha',
      lvLabel: 'Nv.',
      mapHint: 'Toca un nodo del árbol para ver su descripción abajo.',
      listTitle: 'Nivel a nivel',
      colStep: 'Paso',
      colEffect: 'Elección',
      colWhy: 'Por qué',
      skills: [
        { effect: '+1.500 de cobre por cada Cesare abatido', why: 'Desbloquea habilidades pronto mientras suma puntos constantes' },
        { effect: 'Más velocidad de marcha', why: 'Acelera tu rotación de Cesare / vetas' },
        { effect: '+5.000 de cobre al capturar una veta normal', why: 'La principal fuente de puntos del evento' },
        { effect: 'Más eficiencia al recolectar cobre', why: 'Mejor en vetas de grieta y vetas de nivel alto' },
        { effect: 'Más velocidad de recolección durante un tiempo', why: 'Para recolectar vetas normales al final' },
      ],
      tipsIntro: 'Agrupados por fase, desde la preparación antes de entrar hasta el último minuto. Toca un grupo para abrirlo.',
      tipCount: '',
      tipGroups: [
        {
          header: 'Antes y al empezar',
          tips: [
            {
              n: 1,
              title: 'Revisa primero cuántas colas de marcha tienes',
              body: 'Antes de que empiece el evento, mira cuántas colas de marcha puedes usar (p. ej. 4 · 5 · 6).',
              note: 'Con más colas puedes matar a Cesare, capturar vetas y recolectar grietas a la vez: aquí es una ventaja real.',
            },
            {
              n: 2,
              title: 'Estudia tu alrededor al entrar',
              bullets: [
                'Cuántos Cesare hay cerca y qué tan juntos',
                'Dónde están las vetas normales',
                'Cuántas vetas siguen sin atacar',
                'Qué tan densas están las ciudades de jugadores',
                'Hacia dónde hay menos rivales',
              ],
              note: 'Con muchos jugadores alrededor pierdes Cesare y vetas rápido, así que tu posición inicial importa.',
            },
            {
              n: 3,
              title: 'Al principio, solo mata Cesare',
              doList: [
                { ok: true, text: 'Matar Cesare: envía todas las marchas' },
                { ok: false, text: 'Recolectar vetas normales: todavía no' },
              ],
              note: 'Al principio, subir habilidades matando Cesare rápido es mejor que quedarse recolectando en una veta.',
            },
            {
              n: 4,
              title: 'Usa el teletransporte gratis',
              body: 'El teletransporte gratis se desbloquea bastante pronto tras el inicio; la espera es de unos 2 minutos.',
              bullets: ['Cuando se acaban los Cesare cerca', 'Cuando las vetas cercanas ya están usadas', 'Para salir de una zona con demasiados rivales'],
              note: 'En vez de quedarte en un sitio, ve moviéndote a zonas con Cesare y vetas sin capturar.',
            },
            {
              n: 5,
              title: 'Llega a Nv. 3 lo antes posible',
              body: 'Desbloquear el Nv. 3 es la máxima prioridad al principio. Céntrate en Cesare hasta entonces y solo después empieza a atacar vetas normales.',
              flow: ['Empieza el evento', 'Todas las marchas matan Cesare', 'Ganas experiencia de habilidad', 'Desbloqueas el Nv. 3', 'Empiezas el ciclo de vetas de 5.000 de cobre'],
            },
          ],
        },
        {
          header: 'El ciclo de vetas de 5.000 de cobre',
          tips: [
            {
              n: 6,
              title: 'Vigila la bonificación de veta de 1 minuto',
              body: 'Al llegar a Nv. 3 aparece en tu barra de bonificaciones una bonificación de puntos de veta. Captura una veta normal mientras está activa para ganar puntos extra.',
              flow: ['Bonificación activa', 'Capturas una veta normal', 'Ganas 5.000', 'La bonificación desaparece', '1 min de espera', 'Vuelve la bonificación'],
              note: 'La espera de 1 minuto no se muestra en ningún sitio: recuerda cuándo capturaste o fíjate en cuándo vuelve a aparecer el icono.',
            },
            {
              n: 7,
              title: 'Ataca una veta nueva cada vez que vuelva la bonificación',
              flow: ['Bonificación activa', 'Atacas una veta normal', 'Ganas 5.000', 'Retiras las tropas', 'Vuelves a cazar Cesare'],
              note: 'No te quedes en una veta. Cazar puntúa más, así que usa las vetas normales sobre todo para activar los 5.000.',
            },
            {
              n: 8,
              title: 'Deja siempre una marcha libre',
              body: 'No comprometas todas las marchas: deja al menos una esperando.',
              bullets: ['Sale en cuanto vuelve la bonificación', 'Captura la veta normal más cercana', 'Se retira justo después de los 5.000', 'Espera la siguiente recarga'],
              note: 'Así evitas que la bonificación aparezca sin ninguna marcha libre para usarla.',
            },
            {
              n: 9,
              title: 'Muévete cuando se agoten las vetas de la zona',
              body: 'Si ya capturaste todas las vetas cercanas o otros llegaron antes, sal con el teletransporte gratis.',
              bullets: ['Vetas aún sin capturar', 'Muchos Cesare todavía', 'Pocas ciudades de jugadores alrededor', 'Una veta normal justo al lado de tu ciudad'],
            },
            {
              n: 10,
              title: 'Pon tu ciudad justo al lado de una veta normal',
              flow: ['Asegura una veta junto a tu ciudad', 'Una marcha se encarga del temporizador de 60 s', 'Captura en cuanto aparezca la bonificación', 'Retírate justo después de los 5.000', 'Las demás marchas siguen con Cesare'],
              note: 'Con marchas más cortas es mucho más difícil perderse la bonificación que vuelve cada minuto.',
            },
            {
              n: 11,
              title: 'Que la carreta de carga nunca esté parada',
              body: 'Atacar por primera vez una veta de Cesare deja pequeños montones de cobre cerca: normalmente 3, que se recogen de uno en uno.',
              bullets: ['No usa una ranura de marcha normal', 'Funciona a la vez que tu caza de Cesare', 'Hay que volver a enviarla en cuanto termina'],
              flow: ['Ves un montón de cobre', 'Envías la carreta', 'Recogida terminada', 'La envías al siguiente montón'],
            },
          ],
        },
        {
          header: 'Vetas de grieta',
          tips: [
            {
              n: 12,
              title: 'Prepárate 60 segundos antes de que aparezca',
              bullets: ['Para todos los ataques a Cesare', 'Retira las marchas de las vetas normales', 'Trae todas las marchas a casa', 'Aleja el zoom del minimapa', 'Prepárate para localizar la grieta'],
              note: 'Las vetas de grieta dan cobre rápido en poco tiempo, así que importa tener todas las marchas allí en cuanto se abre.',
            },
            {
              n: 13,
              title: 'Reparto con 6 marchas',
              bullets: ['5 marchas → directas a la veta de grieta', '1 marcha → activa los 5.000 en una veta normal cercana y luego se une a la grieta'],
              note: 'Si la bonificación de veta aún está en espera, envía las 6 a la grieta. Mientras hay una grieta abierta, va por delante de cazar Cesare.',
            },
          ],
        },
        {
          header: 'Habilidad activa derecha de Nv. 5',
          tips: [
            {
              n: 14,
              title: 'Lanza la habilidad primero y luego entra en la veta',
              flow: ['Usa la activa derecha de Nv. 5', 'Envía tropas a una veta normal', 'Se mantiene la velocidad de recolección del momento de entrar'],
              note: 'Si entras primero en la veta y lanzas después, puede que no tengas el efecto: lanza siempre y luego entra.',
            },
            {
              n: 15,
              title: 'Funciona como una foto fija',
              flow: ['Habilidad activa', 'Entras en una veta normal', 'Se aplica la velocidad de recolección aumentada', 'Esa marcha conserva la velocidad cuando termina la habilidad'],
              note: 'Así que mete en vetas normales todas las marchas que puedas mientras dura.',
            },
            {
              n: 16,
              title: 'NO se aplica a las vetas de grieta',
              doList: [
                { ok: true, text: 'Vetas normales Nv. 2–Nv. 3: recomendado' },
                { ok: false, text: 'Vetas de grieta: el 50 % de velocidad no se aplica; lanzarla es desperdiciarla' },
              ],
            },
            {
              n: 17,
              title: 'Los mejores momentos para usarla',
              bullets: [
                'Justo después de que termine la segunda fase de grietas',
                'Aproximadamente 1 minuto antes del final del evento',
                'Cuando hay varias vetas normales Nv. 2–Nv. 3 seguras disponibles',
                'Cuando todas tus marchas están en casa',
              ],
              flow: ['Todas las marchas en casa', 'Usa la activa derecha de Nv. 5', 'Envía todas las marchas a vetas Nv. 2–Nv. 3', 'Recolecta hasta el final'],
            },
          ],
        },
        {
          header: 'Cima de la Eternidad (centro)',
          tips: [
            {
              n: 18,
              title: 'Se abre unos 7 minutos antes del final',
              body: 'La Cima de la Eternidad del centro se abre unos 7 minutos antes de que termine el evento. El ranking por tiempo de ocupación da recompensas extra, pero atrae a los jugadores más fuertes del campo.',
            },
            {
              n: 19,
              title: 'F2P / gasto medio: no la mantengas mucho',
              body: 'Con una plantilla de héroes Gen 2 y gasto gratis o medio, no se recomienda mantener el centro mucho tiempo.',
              bullets: [
                'Una derrota deja a tu héroe en espera por heridas',
                'Se pierde tiempo de marcha solo en llegar al centro',
                'Probablemente te cruzarás una y otra vez con defensores fuertes',
                'Tu caza de Cesare se detiene',
                'Tu ciclo de vetas de 5.000 de cobre se detiene',
                'Varias marchas se quedan atadas a la pelea del centro',
              ],
              note: 'Si un jugador fuerte ya la tiene, no sigas lanzando ataques: mantener la caza de Cesare y el ciclo de 5.000 puntúa más.',
            },
          ],
        },
      ],
      stampTitle: 'Guion de los 30 minutos',
      stampIntro: 'Las horas son las del reloj de cuenta atrás. Mientras no te pierdas la aparición de las grietas y la activa de Nv. 5, vas bien.',
      stamps: [
        {
          time: '30:00',
          title: 'Empieza el evento',
          key: true,
          items: ['Envía todas las marchas a Cesare', 'Todavía no toques las vetas normales', 'Desbloquea habilidades rápido: derecha → derecha → izquierda'],
        },
        {
          time: '29:00–28:00',
          title: 'Mira la densidad de la zona',
          items: ['Cuenta los Cesare que tienes alrededor', '¿Demasiadas ciudades cerca? Prepárate para moverte', 'Empieza a recoger montones de cobre con la carreta'],
        },
        {
          time: '~28:00',
          title: 'Se desbloquea el teletransporte gratis',
          items: ['Muévete ya si hay pocos Cesare o muchos rivales', 'Elige un sitio con Cesare y vetas normales sin capturar'],
        },
        {
          time: '28:00 → Nv. 3',
          title: 'Todo a Cesare hasta el Nv. 3',
          items: ['Todas las marchas siguen matando Cesare', 'Todavía nada de recolectar vetas', 'La carreta sigue recogiendo cobre sin parar'],
        },
        {
          time: 'Nv. 3 alcanzado',
          title: 'Pasa al ciclo',
          key: true,
          items: ['Una marcha se dedica por completo a la veta de 5.000', 'Las demás siguen cazando Cesare', 'Si se acaban los Cesare, recolecta vetas normales Nv. 2–Nv. 3'],
        },
        {
          time: 'Tras el Nv. 3',
          title: 'Repite el ciclo de 5.000',
          items: [
            'Comprueba que la bonificación de veta está activa',
            'Captura con una marcha la veta normal más cercana',
            'Retírala justo después de los 5.000',
            'Las demás cazan Cesare o recolectan vetas normales',
            'Repite cada vez que vuelva la bonificación',
          ],
        },
        {
          time: '~21:00',
          title: 'Prepara la primera grieta',
          items: ['Deja de empezar ataques nuevos a Cesare', 'Retira las marchas de las vetas normales', 'Trae todas las marchas a casa', 'Aleja el zoom y vigila la grieta'],
        },
        {
          time: '~20:00',
          title: 'Aparece la primera veta de grieta',
          key: true,
          items: [
            'Envía la mayoría de marchas a la grieta de inmediato',
            'Bonificación activa → una marcha toma primero los 5.000 y luego se une a la grieta',
            'Bonificación inactiva → envía todas las marchas a la grieta',
          ],
        },
        {
          time: 'Tras la grieta',
          title: 'Vuelta al ciclo',
          items: [
            'Una marcha vuelve a encargarse de la veta de 5.000',
            'Las demás cazan Cesare',
            'Si hay pocos Cesare, recolecta vetas Nv. 2–Nv. 3',
            'Si la zona está agotada, sal con el teletransporte gratis',
          ],
        },
        {
          time: '~11:00',
          title: 'Prepara la segunda grieta',
          items: ['Deja de empezar ataques nuevos a Cesare', 'Retira las marchas que recolectan', 'Trae todas las marchas a casa', 'Prepárate para localizar la grieta'],
        },
        {
          time: '~10:00',
          title: 'Aparece la segunda veta de grieta',
          key: true,
          items: ['Hazlo exactamente como la primera', 'Bonificación activa → una marcha toma la veta y luego se une a la grieta', 'Las demás llegan pronto a la grieta'],
        },
        {
          time: 'Tras la grieta',
          title: 'Vuelta al ciclo (2.ª)',
          items: ['Una marcha en la veta de 5.000', 'Las demás cazan Cesare o recolectan vetas', 'Todavía NO uses la activa derecha de Nv. 5'],
        },
        {
          time: '~07:00',
          title: 'Se abre la Cima de la Eternidad',
          items: [
            'Salvo que seas una ballena grande, sáltate el centro',
            'Mantén tu ciclo de puntos en vez de pelear allí',
            'Una marcha en la veta de 5.000',
            'Las demás cazan Cesare o recolectan vetas seguras',
          ],
        },
        {
          time: '07:00–03:00',
          title: 'Suma los últimos puntos',
          items: ['Prioriza los Cesare cercanos', 'Evita atacar los lejanos', 'Toma los 5.000 cada vez que esté la bonificación', 'Mantén la carreta en los montones de cobre'],
        },
        {
          time: '03:00–02:00',
          title: 'Prepara el final',
          items: ['Deja de atacar Cesare lejanos', 'Busca vetas normales Nv. 2–Nv. 3', 'Organízate para que todas las marchas puedan volver rápido'],
        },
        {
          time: '~01:00',
          title: 'Usa la activa derecha de Nv. 5',
          key: true,
          items: [
            'Trae todas las marchas a casa',
            'Lanza PRIMERO la activa derecha de Nv. 5',
            'Luego mete todas las marchas en vetas normales Nv. 2–Nv. 3 seguras',
            'Nunca gastes esta activa en una veta de grieta',
          ],
        },
        { time: '00:00', title: 'Termina el evento', items: ['Revisa tu puntuación final y tu posición'] },
      ],
      failTitle: 'Las formas más comunes de perder puntos',
      failHeadMistake: 'Error',
      failHeadProblem: 'Lo que cuesta',
      fails: [
        { mistake: 'Recolectar vetas desde el principio', problem: 'El Nv. 3 llega demasiado tarde' },
        { mistake: 'Recolectar 5–6 vetas normales a la vez', problem: 'Los 5.000 solo se activan una vez cada 60 s' },
        { mistake: 'No llevar la cuenta de cuándo capturaste', problem: 'Vuelves a entrar antes de tiempo y pierdes los 5.000' },
        { mistake: 'Dejar de cazar Cesare al terminar las habilidades', problem: 'Pierdes los 1.500 constantes por cada uno' },
        { mistake: 'Dejar la carreta de carga parada', problem: 'Puntos gratis que no te cuestan ninguna marcha' },
        { mistake: 'Retirar marchas solo tras el aviso de grieta', problem: 'Demasiado tarde: pierdes la carrera por la grieta' },
        { mistake: 'Usar la activa de Nv. 5 en una grieta', problem: 'El 50 % no se aplica a las vetas de grieta' },
        { mistake: 'Atacar el centro una y otra vez', problem: 'Esperas de héroes y tiempo de marcha perdido' },
        { mistake: 'Quedarse en una zona llena de gente', problem: 'Pierdes Cesare y vetas' },
        { mistake: 'No retirar las marchas que están fuera', problem: 'No puedes entrar al campo de batalla' },
      ],
      scoreIntro: 'El cobre es la puntuación. Cuando sabes de dónde sale, está claro dónde poner cada marcha.',
      srcTitle: 'De dónde salen los puntos (por prioridad)',
      srcHead: ['Fuente · condición', 'Ganancia'],
      sources: [
        { source: 'Bonificación por capturar veta normal', cond: 'Capturar una veta normal tras elegir la izquierda de Nv. 3', gain: '+5.000 cada 60 s' },
        { source: 'Bonificación por abatir Cesare', cond: 'Matar Cesare tras elegir la derecha de Nv. 1', gain: '+1.500 cada uno' },
        { source: 'Veta de grieta', cond: 'Terminar de recolectar una veta de grieta', gain: '~+4.000 cada una' },
        { source: 'Montones pequeños de cobre', cond: 'Los recoge la carreta de carga', gain: 'El cobre que se muestre' },
        { source: 'Recolección de vetas normales', cond: 'Enviar tropas a recolectar una veta', gain: 'Ritmo según el nivel' },
        { source: 'Cima de la Eternidad', cond: 'Ranking por tiempo de ocupación del centro', gain: 'Extra según el puesto' },
      ],
      srcNote: 'La derecha de Nv. 1 da 1.500 de cobre por Cesare; la izquierda de Nv. 3 da 5.000 al capturar una veta normal, con 60 segundos de espera. Una veta de grieta da unos 4.000 de cobre.',
      skillScoreTitle: 'Cuánto vale cada elección recomendada',
      skillScoreHead: ['Habilidad', 'Efecto', 'Puntos directos'],
      skillScores: [
        { lv: 'Nv. 1', side: 'Derecha', effect: 'Bonificación por abatir Cesare', score: '+1.500 / abatido' },
        { lv: 'Nv. 2', side: 'Derecha', effect: 'Más velocidad de marcha', score: 'Ninguno' },
        { lv: 'Nv. 3', side: 'Izquierda', effect: 'Bonificación por capturar veta normal', score: '+5.000 / 60 s' },
        { lv: 'Nv. 4', side: 'Izquierda', effect: 'Más eficiencia al recolectar cobre', score: 'Más recolectado' },
        { lv: 'Nv. 5', side: 'Derecha', effect: '+50 % de velocidad en vetas normales durante 60 s', score: 'Más recolectado' },
      ],
      rateTitle: 'Ritmo base de recolección por veta',
      rateHead: ['Veta', 'Ritmo base', 'Por minuto'],
      rates: [
        { vein: 'Veta normal Nv. 1', rate: '8 / s', perMin: '480' },
        { vein: 'Veta normal Nv. 2', rate: '16 / s', perMin: '960' },
        { vein: 'Veta normal Nv. 3', rate: '32 / s', perMin: '1.920' },
        { vein: 'Veta de grieta', rate: '200 / s', perMin: '~4.000 por veta' },
      ],
      rateNote: 'Cada nivel de veta normal duplica el ritmo de recolección.',
      boostTitle: 'Ritmo de recolección con las habilidades',
      boostHead: ['Veta', 'Base', 'Nv. 4', 'Nv. 5', 'Nv. 4+5'],
      boosts: [
        { vein: 'Nv. 1', base: '8/s', lv4: '9,2/s', lv5: '12/s', both: '13,2/s' },
        { vein: 'Nv. 2', base: '16/s', lv4: '18,4/s', lv5: '24/s', both: '26,4/s' },
        { vein: 'Nv. 3', base: '32/s', lv4: '36,8/s', lv5: '48/s', both: '52,8/s' },
        { vein: 'Grieta', base: '200/s', lv4: '230/s', lv5: 'n/d', both: '230/s' },
      ],
      boostNote: 'El +50 % de la activa derecha de Nv. 5 solo se aplica a vetas normales, nunca a las de grieta.',
      exTitle: 'Ejemplo práctico con 6 marchas',
      exHead: ['Fuente', 'Cálculo de ejemplo', 'Esperado'],
      examples: [
        { source: 'Bonificación por capturar veta normal', calc: '5.000 × 20', score: '100.000' },
        { source: 'Cesare abatidos', calc: '1.500 × 50–80', score: '75.000–120.000' },
        { source: 'Vetas de grieta', calc: '6 marchas × 4.000 × 4 oleadas', score: 'hasta 96.000' },
        { source: 'Montones pequeños de cobre', calc: 'La carreta recogiendo sin parar', score: '~15.000–30.000' },
        { source: 'Recolección de vetas normales', calc: 'Recolectar Nv. 1–Nv. 3', score: 'Extra según la situación' },
        { source: 'Cima de la Eternidad', calc: 'Ranking por tiempo de ocupación del centro', score: 'Extra según el puesto' },
      ],
      exTotalLabel: 'Total esperado',
      exTotal: '~286.000–346.000 + recolección de vetas + extra del centro',
      exNote: 'Las cuatro oleadas de grietas y las cifras de los montones suponen cierto nivel de competencia y que ganas las apariciones: no están garantizadas. Una grieta vale unos 4.000.',
    }
  return {
