...
const STR: Record<string, Entry> = {
  ...
  'r856.hostDesc': {
    en: 'Open your own rally at 10/10/80 (100K). Every other march you send is a plain 8/8/56 join.',
    ko: '자기 집결은 10/10/80 (100K)으로 엽니다. 그 외에 보내는 행군은 전부 8/8/56 렐리입니다.',
  },
  'r856.joinDesc': {
  ...
  'r856.marches': { en: 'Marches', ko: '행군 수' },
  'r856.hostMarchHint': { en: 'March 1 is your own rally, the rest are 8/8/56 joins.', ko: '1번은 자기 집결, 나머지는 전부 8/8/56 참여.' },
  'r856.joinMarchHint': { en: 'How many rallies you plan to join.', ko: '참여할 렐리 개수를 입력하세요.' },
  'r856.owned': { en: 'Your troops', ko: '보유 병력' },
  'r856.ownedHint': { en: 'Raw troop counts, not K — e.g. 320000.', ko: 'K가 아니라 실제 병력 수 — 예: 320000.' },
  ...
  'r856.planHost': { en: 'rally + {n} × 8/8/56', ko: '집결 + 8/8/56 × {n}' },
