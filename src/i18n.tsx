...
const STR: Record<string, Entry> = {
  ...
  'deploy.cav': { en: 'Cavalry', ko: '기병' },
  'deploy.arc': { en: 'Archer', ko: '궁병' },
  'deploy.capacityLabel': { en: 'March size', ko: '병력 규모' },
  'deploy.remove': { en: 'Remove', ko: '제거' },
  'deploy.ratio': { en: 'Troop ratio', ko: '병사 비율' },
  'deploy.cancelAll': { en: 'Clear all', ko: '일괄취소' },
  'deploy.even': { en: 'Even', ko: '균등배치' },
  'deploy.proportional': { en: 'By ratio', ko: '비례 배치' },
  'deploy.save': { en: 'Save', ko: '저장' },
  'deploy.marches': { en: 'March queues', ko: '행군 대열 수' },
  'deploy.legendBT': {
    en: 'Sample setups for a bear trap run. The first hero is what matters.',
    ko: '베어트랩 진행시 예시로 만든 설정. 첫 영웅이 중요합니다.',
  },
  'deploy.legendA': { en: 'Heroes and troop ratio for attack rallies.', ko: '공격 집결에 사용되는 영웅과 병력 비율.' },
  'deploy.legendD': { en: 'Heroes and troop ratio for defense.', ko: '수비에 사용되는 영웅과 병력 비율.' },
  'deploy.legendNote': {
    en: 'These are examples — you may be asked to change them for the real run.',
    ko: '이것은 예시이며 실전에는 변경을 요청할 수 있습니다.',
  },
  'deploy.pickTitle': { en: 'Select hero', ko: '영웅 선택' },
  'deploy.sort': { en: 'Sort', ko: '정렬' },
  'deploy.sortPower': { en: 'Power', ko: '전투력' },
  'deploy.pickEmpty': { en: 'All three classes are already fielded.', ko: '세 병종이 모두 배치되어 있습니다.' },
  'deploy.close': { en: 'Done', ko: '닫기' },
  'deploy.ratioNote': {
  ...
  'deploy.confirm': { en: 'Confirm', ko: '확인' },
  'deploy.saveTitle': { en: 'Formation', ko: '편대 진영' },
  'deploy.savePick': { en: 'Pick a formation slot.', ko: '편대를 선택하세요.' },
  'deploy.slotName': { en: 'Formation {n} name', ko: '편대 {n} 이름' },
  'deploy.nameRule': { en: '1-3 characters, letters and numbers only.', ko: '1~3글자, 문자와 숫자만 사용할 수 있습니다.' },
  'deploy.saveMode': { en: 'Choose how to save.', ko: '저장 방식을 선택해 주세요.' },
  'deploy.saveByCount': { en: 'Save by troop count', ko: '병사 수량에 따라 저장' },
  'deploy.saveByRatio': { en: 'Save by troop ratio', ko: '병사의 비율에 따라 저장' },
  'deploy.saveWarn': { en: 'Saving overwrites the formation already in that slot.', ko: '저장 후 기존의 편대 진영이 덮어씌워집니다.' },
  ...
  'sec.enemy': { en: 'Enemy', ko: '적 정보' },
  'sec.build': { en: 'Buildings', ko: '건물' },
  'sec.skill': { en: 'Skills', ko: '스킬트리' },
  'sec.stamp': { en: 'Run of show', ko: '타임스탬프' },
  'sec.score': { en: 'Scoring', ko: '점수' },
  'sec.result': { en: 'Results', ko: '결과' },
  ...
  'events.governor': { en: 'Kingdom of Power', ko: '최강 왕국' },
  ...
  'calc.capacity': { en: 'Slot size', ko: '슬롯 기본 크기' },
  'calc.capHint': { en: `Default per slot = the ${JOIN_CAP_K}K join cap. Set your own-rally slot to your capacity.`, ko: `슬롯 기본값 = 참여 제한 ${JOIN_CAP_K}K. 자기 집결 슬롯은 내 수용량에 맞춰 수정하세요.` },
  ...
  'calc.autoFill': { en: 'Standard', ko: '기본 구성' },
  ...
  'calc.filled': { en: 'Filled slots to the standard march', ko: '기본 구성으로 채웠습니다' },
  ...
  'r856.hostTab': { en: `${CAP} host`, ko: `${CAP} 집결자` },
  'r856.joinTab': { en: `${CAP} joiner`, ko: `${CAP} 참여자` },
  'r856.hostTitle': { en: `${CAP} rally — host`, ko: `${CAP} 렐리 · 집결자` },
  'r856.joinTitle': { en: `${CAP} rally — joiner`, ko: `${CAP} 렐리 · 참여자` },
  'r856.hostDesc': {
  ...
  'r856.chipRally': { en: 'Your rally', ko: '자기 집결' },
  'r856.chipJoin': { en: 'Join march', ko: '참여 행군' },
  'r856.sizeTitle': { en: 'March size', ko: '행군 크기' },
  'r856.howBtn': { en: 'How it works', ko: '설명' },
  'r856.how1Title': { en: '1. Max troop size — your own march', ko: '1. 최대 병력 규모 — 내 행군 크기' },
  'r856.how1Body': {
  ...
  'r856.how2Title': { en: '2. Join cap — the host sets it', ko: '2. 참여 제한 — 집결자가 정한 행군당 상한' },
  'r856.how2Body': {
  ...
  'r856.hostMarches': { en: 'Join marches', ko: '참여 행군 수' },
  'r856.joinMarches': { en: 'Marches', ko: '행군 수' },
  'r856.hostMarchHint': {
  ...
  'r856.joinMarchHint': { en: 'How many rallies you plan to join.', ko: '참여할 렐리 개수를 입력하세요.' },
  'r856.owned': { en: 'Your troops', ko: '보유 병력' },
  'r856.ownedHint': { en: 'Exact troop counts — e.g. 320000.', ko: '실제 병력 수 그대로 — 예: 320000.' },
  'r856.ownedHintK': { en: 'In thousands — type 320 for 320,000.', ko: '천 단위 — 320을 넣으면 320,000입니다.' },
  'r856.unitExact': { en: 'Exact', ko: '숫자' },
  'r856.ownedTotal': { en: 'total {n}', ko: '합계 {n}' },
  'r856.calc': { en: 'Calculate', ko: '계산하기' },
  'r856.shortTitle': { en: 'Not enough troops', ko: '병력이 부족합니다' },
  'r856.enoughTitle': { en: 'You have enough', ko: '병력이 충분합니다' },
  'r856.shortSuffix': { en: 'short', ko: '부족' },
  'r856.ok': { en: 'enough', ko: '충분' },
  'r856.spare': { en: 'left', ko: '남음' },
  'r856.covered': { en: 'Your troops only fill {n} of {total} marches.', ko: '보유 병력으로는 {total}개 중 {n}개 행군만 채울 수 있습니다.' },
  'r856.enoughBody': { en: 'All {n} marches are covered.', ko: '{n}개 행군을 모두 채울 수 있습니다.' },
  'r856.needTitle': { en: 'Troops needed', ko: '필요 병력' },
  'r856.have': { en: 'have', ko: '보유' },
  'r856.planTitle': { en: 'March plan', ko: '행군 구성' },
  'r856.planHost': { en: 'your rally + {n} joins', ko: '자기 집결 + 참여 × {n}' },
  'r856.planJoin': { en: '{n} joins', ko: '참여 × {n}' },
  'r856.rowRally': { en: 'Your rally', ko: '자기 집결' },
  'r856.rowJoin': { en: 'Join', ko: '참여' },
  'r856.rowOk': { en: 'covered', ko: '가능' },
  'r856.rowShort': { en: 'short', ko: '부족' },
  'r856.note': {
  ...
  'lead.title': { en: 'Slot-1 hero check', ko: '1번 영웅 판정기' },
  'lead.prompt': { en: 'Tap the hero you put in slot 1.', ko: '내 1번 영웅을 눌러 보세요.' },
  'lead.allowed': { en: 'OK in slot 1', ko: '1번 영웅 가능' },
  'lead.conditional': { en: 'Depends on skill', ko: '스킬 레벨에 따라' },
  'lead.banned': { en: 'Not in slot 1', ko: '1번 영웅 금지' },
  'lead.whyAllowed': {
  ...
  'slots.pillWhy': { en: `${CAP} rule`, ko: `${CAP} 규칙` },
...
export function calcGuide(lang: Lang): string[] {
  if (lang === 'ko')
    return [
      '역할(메인 / 서브 / 일반)에 따라 1번 슬롯이 자기 집결인지 참여인지가 달라집니다.',
  ...
  return [
    'Your role (Main / Support / General) decides whether slot 1 is your own rally or a join.',
...
/** Every quick-slot example is the standard join march; a reserve slot is empty. */
const STD_SLOT = { infK: JOIN_INF_K, cavK: JOIN_CAV_K, arcK: JOIN_ARC_K }
const EMPTY_SLOT = { infK: 0, cavK: 0, arcK: 0 }
...
export function slotsContent(lang: Lang): SlotsContent {
  if (lang === 'ko')
    return {
      ...
      whyPoints: [
        ...
        '좋은 집결(30메인)에 먼저 참여하고, 꽉 차면 서브 집결에 참여합니다.',
      ],
      ...
      examplesTag: '예시',
      examplesLead: `이건 퀵슬롯 설정 예시입니다. 모든 참여 슬롯은 ${STD_KO} = ${CAP} 기준입니다.`,
      examplesNote: `보유 병력 ÷ ${CAP}만큼 행군을 만들 수 있습니다. 예시는 메인=총 430K, 서브·일반=총 300K 기준 — 각 카드 상단은 「총 병력 − 남는 병력 = 실제 투입」입니다. 집결자 본인 행군은 참여 제한을 받지 않으니, 자기 집결은 수용량까지 채워도 됩니다.`,
      cards: [
        {
          title: '메인 집결자',
          tag: `30 · T10 · ${CAP} × 4`,
          rawK: 430,
          slots: [
            { n: 1, title: '자기 집결 (호스트)', purpose: `참여 제한 ${CAP} 설정 · 본인 행군은 수용량까지`, ...STD_SLOT, note: '자기 집결은 제한을 받지 않습니다.' },
            { n: 2, title: '첸코 참여', purpose: '다른 30메인 집결에 참여', ...STD_SLOT },
            { n: 3, title: '연우 참여', purpose: '보조 참여', ...STD_SLOT },
            { n: 4, title: '아마네 참여', purpose: '남는 병력으로 참여', ...STD_SLOT },
          ],
        },
        {
          title: '서브 집결자',
          ...
          rawK: 300,
          slots: [
            { n: 1, title: '30메인 참여', purpose: '가진 병력을 30메인에', ...STD_SLOT },
            { n: 2, title: '자기 서브 집결 (호스트)', purpose: `overflow 받기 · 참여 제한 ${CAP} 설정`, ...STD_SLOT },
            { n: 3, title: '첸코 / 연우 참여', purpose: '남는 병력으로 참여', ...STD_SLOT },
            { n: 4, title: '예비', purpose: '부족하면 무리하지 않기', ...EMPTY_SLOT },
          ],
        },
        {
          title: '일반 참여자',
          ...
          rawK: 300,
          slots: [
            { n: 1, title: '30메인 전용', purpose: '가진 병력을 30메인에', ...STD_SLOT },
            { n: 2, title: '첸코 참여', purpose: '다른 집결에 참여', ...STD_SLOT },
            { n: 3, title: '연우 / 서브 참여', purpose: '메인 초과 시 서브 참여', ...STD_SLOT },
            { n: 4, title: '예비', purpose: '남는 병력', ...EMPTY_SLOT },
          ],
        },
      ],
      notesTitle: '참고',
  ...
  return {
    ...
    whyPoints: [
      ...
      'Join a good rally (30-main) first; if it is full, join a support rally.',
    ],
    ...
    examplesTag: 'Example',
    examplesLead: `These are quick-slot setup examples. Every join slot is ${STD_EN} = ${CAP}.`,
    examplesNote: `You can build as many marches as your troops ÷ ${CAP}. Examples: Main = 430K total; Support/General = 300K total — each card's header reads total − left over = actually sent. A host's own march is not under the join cap, so your own rally can be filled to your capacity.`,
    cards: [
      {
        title: 'Main leader',
        tag: `30 · T10 · ${CAP} × 4`,
        rawK: 430,
        slots: [
          { n: 1, title: 'Own rally (host)', purpose: `Set the join cap to ${CAP} · your own march fills your capacity`, ...STD_SLOT, note: 'Your own rally is not capped.' },
          { n: 2, title: 'Chenko join', purpose: 'Join another 30-main rally', ...STD_SLOT },
          { n: 3, title: 'Yeonwoo join', purpose: 'Side join', ...STD_SLOT },
          { n: 4, title: 'Amane join', purpose: 'Join with what is left', ...STD_SLOT },
        ],
      },
      {
        ...
        rawK: 300,
        slots: [
          { n: 1, title: 'Join a 30 main', purpose: 'Send what you have to the 30-main', ...STD_SLOT },
          { n: 2, title: 'Own support rally (host)', purpose: `Absorb overflow · set the join cap to ${CAP}`, ...STD_SLOT },
          { n: 3, title: 'Chenko / Yeonwoo join', purpose: 'Join with leftover troops', ...STD_SLOT },
          { n: 4, title: 'Reserve', purpose: "Do not overreach if you're short", ...EMPTY_SLOT },
        ],
      },
      {
        ...
        rawK: 300,
        slots: [
          { n: 1, title: '30 main only', purpose: 'Send what you have to the 30-main', ...STD_SLOT },
          { n: 2, title: 'Chenko join', purpose: 'Join another rally', ...STD_SLOT },
          { n: 3, title: 'Yeonwoo / support join', purpose: 'If main is full, join a support', ...STD_SLOT },
          { n: 4, title: 'Reserve', purpose: 'Leftover troops', ...EMPTY_SLOT },
        ],
      },
    ],
    notesTitle: 'Notes',
